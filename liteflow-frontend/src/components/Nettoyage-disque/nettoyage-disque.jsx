  ...
  return (
    <div className='nettoyage-disque-container'>
      ...
      <Box sx={{ mt: 2 }}>
        {value === 0 && (
          <div>
            <div className="instructions-nettoyage-disque">
              <strong>Instructions :</strong> Cliquez sur les barres du graphique pour ajouter des catégories de fichiers à la sélection ci-dessus.
            </div>
